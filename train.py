...
def get_parser():
    parser = argparse.ArgumentParser(description='EPHGT')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='0~4 for ETH-univ, ETH-hotel, UCY-zara01, UCY-zara02, UCY-univ; 9 for sdd')
    parser.add_argument(
        '--base_dir',default='.',
...
if __name__ == '__main__':
    ...
    p.model_dir=p.save_base_dir+str(p.test_set)+'/'+p.train_model+'/' # ./savedata/1/EPHGT/'
    p.config=p.model_dir+'/config_'+p.phase+'.yaml' # ./savedata/1/EPHGT/config_train.ymal'
